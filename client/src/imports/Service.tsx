import svgPaths from "./svg-mqvnatvbbw";
...
import imgOverlay from "figma:asset/32a4661f97e2fa2dd2c85c403a7c530b7214e7f7.png";
...
function Heading() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Heading 1">
      <div className="font-['Playfair_Display:Medium',sans-serif] font-medium h-[78px] leading-[72px] relative shrink-0 text-[#161950] text-[72px] tracking-[-1.8px] w-[778px] whitespace-pre-wrap">
        <p className="mb-0">{`Super speciality `}</p>
        <p className="font-['Playfair_Display:Medium_Italic',sans-serif] italic mb-0 text-[#879c84]">oral care</p>
        <p>&nbsp;</p>
      </div>
    </div>
  );
...
function Container3() {
  return (
    <div className="absolute content-stretch flex flex-col h-[51px] items-center left-0 max-w-[672px] pt-[8px] right-[768px] top-[209px]" data-name="Container">
      <div className="-translate-y-1/2 absolute flex flex-col font-['DM_Sans:Light',sans-serif] font-light justify-center leading-[28px] left-[calc(50%-336px)] text-[#5c5e8a] text-[20px] top-[37px] whitespace-nowrap whitespace-pre" style={{ fontVariationSettings: "'opsz' 14" }}>
        <p className="mb-0">Complete oral healthcare for your family, delivered by experienced</p>
        <p className="mb-0">{`specialists using  advanced techniques and a patient-first approach.`}</p>
        <p>&nbsp;</p>
      </div>
    </div>
  );
...
function Container1() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[16px] h-[129px] items-start justify-center left-[131px] top-[88px] w-[1440px]" data-name="Container">
      <Container2 />
      <Heading />
      <Container3 />
    </div>
...
function Footer() {
  return (
    <div className="-translate-x-1/2 absolute bg-[#16184e] bottom-0 content-stretch flex flex-col h-[497px] items-start left-[calc(54.17%-41px)] px-[320px] w-[1920px]" data-name="Footer">
...
function Nav2() {
  return (
    <div className="content-stretch flex gap-[40px] items-center px-[74px] relative shrink-0" data-name="Nav">
      ...
      <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="Component 11">
        <div className="flex flex-col font-['DM_Sans:Medium',sans-serif] font-medium justify-center leading-[0] relative shrink-0 text-[#879c84] text-[16px] whitespace-nowrap" style={{ fontVariationSettings: "'opsz' 14" }}>
...
function Overlay() {
  return (
    <div className="content-stretch flex h-[185px] items-center justify-center relative rounded-[16px] shrink-0 w-[142px]" data-name="Overlay">
      <div aria-hidden="true" className="absolute inset-0 pointer-events-none rounded-[16px]">
        <div className="absolute bg-[rgba(133,156,129,0.1)] inset-0 rounded-[16px]" />
        <img alt="" className="absolute max-w-none object-cover rounded-[16px] size-full" src={imgOverlay} />
      </div>
    </div>
  );
}
...
function Heading1() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Heading 3">
      <div className="flex flex-col font-['Playfair_Display:Medium',sans-serif] font-medium justify-center leading-[0] relative shrink-0 text-[#16184e] text-[24px] tracking-[-0.6px] w-full">
        <p className="leading-[32px]">{`Oral & Maxillofacial Surgery`}</p>
      </div>
    </div>
  );
}
...
function Container21() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-col font-['DM_Sans:9pt_Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#5c5e8a] text-[16px] w-[261px]" style={{ fontVariationSettings: "'opsz' 9" }}>
        <p className="leading-[24px]">Surgical extractions, impacted teeth management, and advanced procedures.</p>
      </div>
    </div>
  );
}
...
function Container20() {
  return (
    <div className="content-stretch flex flex-col gap-[12px] items-start relative shrink-0 w-[280px]" data-name="Container">
      <Heading1 />
      <Container21 />
    </div>
  );
...
function Link() {
  return (
    <div className="absolute content-stretch flex gap-[8px] items-center left-[214px] top-[192px]" data-name="Link">
      <div className="flex flex-col font-['DM_Sans:Medium',sans-serif] font-medium justify-center leading-[0] relative shrink-0 text-[#879c84] text-[16px] whitespace-nowrap" style={{ fontVariationSettings: "'opsz' 14" }}>
        ...
        <div className="absolute bottom-1/2 left-[20.83%] right-[20.83%] top-1/2" data-name="Vector">
          <div className="absolute inset-[-0.67px_-7.14%]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 10.6667 1.33333">
              <path d="M0.666667 0.666667H10" id="Vector" stroke="var(--stroke-0, #879C84)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
            </svg>
          </div>
        </div>
        <div className="absolute bottom-[20.83%] left-1/2 right-[20.83%] top-[20.83%]" data-name="Vector">
          <div className="absolute inset-[-7.14%_-14.29%]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 6 10.6667">
              <path d={svgPaths.p3f0cc030} id="Vector" stroke="var(--stroke-0, #879C84)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
            </svg>
          </div>
        </div>
      </div>
...
function BackgroundShadow() {
  return (
    <div className="absolute bg-white content-stretch flex gap-[40px] h-[249px] items-start left-[128px] overflow-clip p-[32px] rounded-[24px] shadow-[0px_8px_24px_-8px_rgba(22,25,80,0.08)] top-[1207px] w-[572px]" data-name="Background+Shadow">
      <Overlay />
      <Container20 />
      <Link />
    </div>
...
function Heading5() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Heading 3">
      <div className="flex flex-col font-['Playfair_Display:Medium',sans-serif] font-medium justify-center leading-[0] relative shrink-0 text-[#16184e] text-[24px] tracking-[-0.6px] w-full">
        <p className="leading-[32px]">{`Root Canal & Pain Management`}</p>
      </div>
    </div>
  );
}
...
function Container23() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-col font-['DM_Sans:9pt_Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#5c5e8a] text-[16px] w-[269px]" style={{ fontVariationSettings: "'opsz' 9" }}>
        <p className="leading-[24px]">Precise, pain-focused treatment aimed at preserving natural teeth.</p>
      </div>
    </div>
  );
}
...
function BackgroundShadow1() {
  return (
    <div className="absolute bg-white content-stretch flex gap-[40px] h-[249px] items-start left-[calc(50%+20px)] overflow-clip p-[32px] rounded-[24px] shadow-[0px_8px_24px_-8px_rgba(22,25,80,0.08)] top-[1207px] w-[572px]" data-name="Background+Shadow">
      <Overlay1 />
      <Container22 />
      <Link1 />
    </div>
...
function Group4() {
  return (
    <div className="absolute contents left-[128px] top-[1207px]">
      <BackgroundShadow />
      <BackgroundShadow1 />
    </div>
  );
...
function Container25() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-col font-['DM_Sans:9pt_Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#5c5e8a] text-[16px] w-[235px]" style={{ fontVariationSettings: "'opsz' 9" }}>
        <p className="leading-[24px]">Gentle, child-friendly dental care focused on prevention and comfort.</p>
      </div>
    </div>
  );
}
...
function BackgroundShadow2() {
  return (
    <div className="absolute bg-white content-stretch flex gap-[40px] items-start left-[128px] overflow-clip p-[32px] rounded-[24px] shadow-[0px_8px_24px_-8px_rgba(22,25,80,0.08)] top-[1496px] w-[572.429px]" data-name="Background+Shadow">
      <Overlay2 />
      <Container24 />
      <Link2 />
    </div>
...
function Group1() {
  return (
    <div className="absolute contents left-[128px] top-[1496px]">
      <BackgroundShadow2 />
    </div>
  );
}
...
function Heading7() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Heading 3">
      <div className="flex flex-col font-['Playfair_Display:Medium',sans-serif] font-medium justify-center leading-[0] relative shrink-0 text-[#16184e] text-[24px] tracking-[-0.6px] w-full">
        <p className="leading-[32px]">{`Preventive & General Dentistry`}</p>
      </div>
    </div>
  );
}
...
function Container27() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-col font-['DM_Sans:9pt_Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#5c5e8a] text-[16px] w-full" style={{ fontVariationSettings: "'opsz' 9" }}>
        <p className="leading-[24px]">Routine check-ups, cleanings, fillings, and long-term oral health maintenance.</p>
      </div>
    </div>
  );
}
...
function BackgroundShadow3() {
  return (
    <div className="absolute bg-white content-stretch flex gap-[40px] h-[246px] items-start left-[128px] overflow-clip px-[40px] py-[32px] rounded-[24px] shadow-[0px_8px_24px_-8px_rgba(22,25,80,0.08)] top-[632px] w-[572px]" data-name="Background+Shadow">
      <Overlay3 />
      <Container26 />
      <Link3 />
    </div>
...
function Heading8() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Heading 3">
      <div className="flex flex-col font-['Playfair_Display:Medium',sans-serif] font-medium justify-center leading-[0] relative shrink-0 text-[#16184e] text-[24px] tracking-[-0.6px] w-full">
        <p className="leading-[32px]">{`Smile Design & Aesthetic Dentistry`}</p>
      </div>
    </div>
  );
}
...
function Container29() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-col font-['DM_Sans:9pt_Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#5c5e8a] text-[16px] w-full" style={{ fontVariationSettings: "'opsz' 9" }}>
        <p className="leading-[24px]">Smile enhancement through alignment, whitening, and cosmetic restorations.</p>
      </div>
    </div>
  );
}
...
function BackgroundShadow4() {
  return (
    <div className="absolute bg-white content-stretch flex gap-[40px] h-[246px] items-start left-[calc(50%+20px)] overflow-clip px-[40px] py-[32px] rounded-[24px] shadow-[0px_8px_24px_-8px_rgba(22,25,80,0.08)] top-[632px] w-[572px]" data-name="Background+Shadow">
      <Overlay4 />
      <Container28 />
      <Link4 />
    </div>
...
function Group2() {
  return (
    <div className="absolute contents left-[128px] top-[632px]">
      <BackgroundShadow3 />
      <BackgroundShadow4 />
    </div>
  );
...
function Heading9() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Heading 3">
      <div className="flex flex-col font-['Playfair_Display:Medium',sans-serif] font-medium justify-center leading-[0] relative shrink-0 text-[#16184e] text-[24px] tracking-[-0.6px] w-full">
        <p className="leading-[32px]">{`Dental Implants & Prosthodontics`}</p>
      </div>
    </div>
  );
}
...
function Container31() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-col font-['DM_Sans:9pt_Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#5c5e8a] text-[16px] w-[261px]" style={{ fontVariationSettings: "'opsz' 9" }}>
        <p className="leading-[24px]">Functional, aesthetic, and long-lasting tooth replacement solutions.</p>
      </div>
    </div>
  );
}
...
function BackgroundShadow5() {
  return (
    <div className="absolute bg-white content-stretch flex gap-[40px] h-[249px] items-start left-[calc(50%+20px)] overflow-clip p-[32px] rounded-[24px] shadow-[0px_8px_24px_-8px_rgba(22,25,80,0.08)] top-[918px] w-[572px]" data-name="Background+Shadow">
      <Overlay5 />
      <Container30 />
      <Link5 />
    </div>
...
function Container33() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[280px]" data-name="Container">
      <div className="flex flex-col font-['DM_Sans:9pt_Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#5c5e8a] text-[16px] w-[223px]" style={{ fontVariationSettings: "'opsz' 9" }}>
        <p className="leading-[24px]">Braces and clear aligner therapy for children, teens, and adults.</p>
      </div>
    </div>
  );
}
...
function BackgroundShadow6() {
  return (
    <div className="absolute bg-white content-stretch flex gap-[40px] h-[246px] items-start left-[128px] overflow-clip px-[40px] py-[32px] rounded-[24px] shadow-[0px_8px_24px_-8px_rgba(22,25,80,0.08)] top-[921px] w-[572px]" data-name="Background+Shadow">
      <Overlay6 />
      <Container32 />
      <Link6 />
    </div>
...
function Group3() {
  return (
    <div className="absolute contents left-[128px] top-[918px]">
      <BackgroundShadow5 />
      <BackgroundShadow6 />
    </div>
  );
...
export default function Service() {
  return (
    <div className="relative size-full" data-name="Service" style={{ backgroundImage: "linear-gradient(90deg, rgb(255, 249, 240) 0%, rgb(255, 249, 240) 100%), linear-gradient(90deg, rgb(255, 255, 255) 0%, rgb(255, 255, 255) 100%)" }}>
      <Section />
      <Footer />
      <Frame />
      <Group5 />
